...
function init() {
    ...
    else if (UserChoise == 3)
    {
        ...
        let div = document.createElement('div'),
            ...
            divTxt1 = document.createElement('h5'),
            divTxt2 = document.createElement('div'),
            divTxt3 = document.createElement('div');

        div.setAttribute('class', 'mt-2 ms-2 card');
        div.setAttribute('style', 'width:18rem;');
        cardBody.setAttribute('class', '.card-body');

        divTxt1.setAttribute('class', '.card-title')
        divTxt2.setAttribute('class', '.card-text')
        divTxt3.setAttribute('class', '.card-text')
